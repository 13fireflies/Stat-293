...
```{r}
#### PARAMETERS ####
oaldirty = function(n=100, p=20, pC=2, pI=2, pP=2, numtrials=5){
  seed = 293
  mean_x = 0 
  sig_x = 1
  rho = 0
...
```{r}
oaldirty(n=150, p=100, pC=5, pP=5, pI=5)
oaldirty(n=300, p=100, pC=5, pP=5, pI=5)
oaldirty(n=1000, p=100, pC=5, pP=5, pI=5)
oaldirty(n=5000, p=100, pC=5, pP=5, pI=5)
```
