...
simbmatch <- function(sampsize=100, paramrep=1, treated_prob=0.2, seed=293, numtrials=5){
...
Simlations for cardmatch:
```{r}
simcmatch <- function(sampsize=100, paramrep=1, treated_prob=0.2, seed=293, numtrials=5){
  # find tot # of parameters
  numparams <- paramrep*6
  ...
  for(tempseed in c(seed:(seed+numtrials-1))){
    ...
    y <- rbinom(sampsize, size=1, prob=treated_prob)
    test_data <- cbind(y, samp_data(seed=tempseed, sampsize=sampsize, paramrep=paramrep))
